...
{	
	...
	public class SectionConfigPage extends SectionSprite
	{		
		...
		/*constructor：建構值*/
		public function SectionConfigPage() : void
		{
			super(ENUM_SECTION.PAGE_CONFIG);
			
			this.tf_textField = new TextField();
			this.tf_textField.autoSize = TextFieldAutoSize.CENTER;
			this.tf_textField.text = "Config Page";
