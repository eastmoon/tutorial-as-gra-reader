...
{	
	...
	public class SectionReaderPage extends SectionSprite
	{		
		...
		/*constructor：建構值*/
		public function SectionReaderPage() : void
		{
			super(ENUM_SECTION.PAGE_READER);
			
			this.tf_textField = new TextField();
			this.tf_textField.autoSize = TextFieldAutoSize.CENTER;
			this.tf_textField.text = "Reader Page";
